...
const PreHeader = () => {
  return (
    <div className="preheader">
      <div className="preheader__block" style={{ backgroundImage: 'linear-gradient( rgba(47, 57, 66, 0.8), rgba(25, 36, 49, 0.8) ), url(/images/table.jpeg)'}}>
      ...
      <div className="preheader__block" style={{ backgroundImage: 'linear-gradient( rgba(47, 57, 66, 0.8), rgba(25, 36, 49, 0.8) ), url(/images/typing.jpeg)'}}>
